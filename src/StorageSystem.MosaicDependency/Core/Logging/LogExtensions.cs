...
{
    /// <summary>
    /// Class which extends any managed type with log methods to ease the usage of the application log.
    /// </summary>
    public static class LogExtensions
    {
        ...
        public static void Error(this object logInstance, string format, Exception exception, params object[] args)
        {
            ...
            LogManager.GetLogger(logInstance.GetType().Name).Error(exception, errorMessage);
        }
