...
namespace CareFusion.Lib.StorageSystem.Wwks2.Types
{
    ...
    public class Pack : IPack, IInputPack, IDispensedPack
    {
        ...
        /// </summary>
        [XmlIgnore]
        string IInputPack.SerialNumber { get { return TextConverter.UnescapeInvalidXmlChars(this.SerialNumber); } }
        ...
        void IInputPack.SetArticleInformation(string articleId, 
                                              ...
                                              string virtualArticleId,
                                              string virtualArticleName,
                                              bool requiresFridge,
                                              string serialNumber)
        {
            ...
            this.Article = new Article()
            {
                ...
                VirtualId = string.IsNullOrEmpty(virtualArticleId) ? string.Empty : TextConverter.EscapeInvalidXmlChars(virtualArticleId),
                VirtualName = string.IsNullOrEmpty(virtualArticleName) ? string.Empty : TextConverter.EscapeInvalidXmlChars(virtualArticleName),
                RequiresFridge = requiresFridge.ToString(),
                SerialNumber = string.IsNullOrEmpty(serialNumber) ? string.Empty : TextConverter.EscapeInvalidXmlChars(serialNumber)
            };
        }
        ...
        void IInputPack.SetPackInformation(string batchNumber, string externalId, string serialNumber)
        {
            ...
            {
                this.SerialNumber = TextConverter.EscapeInvalidXmlChars(serialNumber);
            }
        }
