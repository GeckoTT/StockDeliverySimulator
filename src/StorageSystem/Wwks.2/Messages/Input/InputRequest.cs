...
namespace CareFusion.Lib.StorageSystem.Wwks2.Messages.Input
{
    ...
    public class InputRequest : MessageBase, IInputRequest
    {
		...
		/// <summary>
		/// This flag identifies the stock input request as part of a stock delivery.
		/// </summary>
		[XmlIgnore]
		bool IInputRequest.IsNewDelivery
		{
			get{ return TypeConverter.ConvertBool( this.IsNewDelivery ); }
		}
        ...
        ///<inheritdoc/>
        [XmlIgnore]
        string IInputRequest.ArticleId
        {
            get
            {
