...
namespace CareFusion.Lib.StorageSystem
{
    ...
    public interface IStorageSystem : IDisposable
    {
        ...
        /// Event which is raised whenever a connected storage system finished an input.
        /// </summary>
        event PackInputFinishedEx PackInputFinishedEx;
        ...
        /// Event which is raised whenever a new pack was successfully stored in a storage system. 
        /// </summary>
        event PackStoredEventHandlerEx PackStoredEx;
        ...
        /// </summary>
        event StorageSystemArticleInfoRequestEventHandler ArticleInfoRequested;
        ...
        /// </returns>
        IInitiateInputRequest CreateInitiateInputRequest(string id,
            int inputSource,
            int inputPoint = 0,
            int destination = 0,
