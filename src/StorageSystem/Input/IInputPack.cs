...
namespace CareFusion.Lib.StorageSystem.Input
{
    ...
    public interface IInputPack
    {
        ...
        /// <summary>
        /// Gets the serial number of the pack.
        /// </summary>
        ...
        /// Optional serial number to use for this pack.
        ...
        /// If this parameter is not null, it will overwrite the originally suggested one of the storage system.
        /// </param>
        void SetPackInformation(string batchNumber, string externalId, string serialNumber = null);
