...
namespace CareFusion.Lib.StorageSystem
{
    ...
    /// <param name="sender">Object instance which raised the event.</param>
    /// <param name="articleList">List of articles with the packs that were stored.</param>
    /// <param name="IsNewDelivery">Flags wheter the input was a new delivery or not.</param>
    public delegate void PackStoredEventHandlerEx(IStorageSystem sender, IArticle[] articleList, bool IsNewDelivery);
    ...
    /// <param name="result">The result of the input request that has been finished.</param>
    /// <param name="articleList">List of articles with the packs that were stored.</param>
    public delegate void PackInputFinishedEx(IStorageSystem sender,
        int source,
        int inputRequestId,
        InputResult result,
        IArticle[] articleList);
    ...
    public delegate void StorageSystemArticleInfoRequestEventHandler(IStorageSystem sender, IStorageSystemArticleInfoRequest request);
}
